...
6. **Appendix** — interview guide (final), respondent list, transcript index. Interview guide
...
Slide deck for the workshop, written report for the final delivery. Both draft from the same
synthesis doc in this folder — never written twice from scratch.
