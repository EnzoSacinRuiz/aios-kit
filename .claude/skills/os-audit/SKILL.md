...
**3. Freshness.** Three things:
   ...
   - The demo banner (`🟡 DEMO`) still present anywhere outside `archives/demo/` — this means `/onboard` was never finished. Tag `poisoning`; this is the worst case because every session loads it.
